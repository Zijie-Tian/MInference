...
# Note: VLLM_USE_V1=0 is removed because vLLM 0.12+ only has V1 engine
VLLM_ALLOW_INSECURE_SERIALIZATION=1 VLLM_WORKER_MULTIPROC_METHOD=spawn VLLM_ALLOW_LONG_MAX_MODEL_LEN=1 \
